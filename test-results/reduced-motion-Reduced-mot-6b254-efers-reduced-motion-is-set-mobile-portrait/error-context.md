...
- Name: reduced-motion.spec.ts >> Reduced motion fork >> parallax layers are not rendered when prefers-reduced-motion is set
- Location: tests/e2e/reduced-motion.spec.ts:4:7
