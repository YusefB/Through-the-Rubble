...
- Name: a11y.spec.ts >> Scene engine a11y >> axe finds no critical or serious violations in before mode
- Location: tests/e2e/a11y.spec.ts:14:7
...
Call log:
  - navigating to "http://localhost:3000/?state=before", waiting until "load"
